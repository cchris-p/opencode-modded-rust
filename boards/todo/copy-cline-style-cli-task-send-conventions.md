...
- FEAT-005 must not discover, start, or reuse servers implicitly. It should talk only to an explicitly configured/provided server/session context or to whatever explicit attach context the implementation defines.
