...
- Covered board items `BUG-011` and `CLI-003` are both in `boards/done/`.
- Implementation landed in merged PR #33, with later `CLI-003` QA closeout confirming fresh local server
  workspace targeting and lowest-free-port behavior.
